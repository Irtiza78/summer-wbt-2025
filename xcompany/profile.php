...
<body>
    <div class="container">
        ...
        <header>
            ...
            <span class="top-right">Logged in as <a href="#"><?php echo $name; ?></a> | <a href="publicHome.php">Logout</a></span>
        </header>
        ...
        <div class="content">
            ...
            <div class="main">
                <div class="profile-box">
                    ...
                    <p><strong>Date of Birth:</strong> <?php echo $dob; ?> <a href="#">Change</a></p>
