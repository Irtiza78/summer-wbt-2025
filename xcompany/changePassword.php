        ...
        <div class="content">
            ...
            <div class="main">
                <div class="profile-box">
                    ...
                    <p><label>Current Password:</label> <input type="password" name="current_password"></p>
                    <p><label class="green">New Password:</label> <input type="password" name="new_password"></p>
                    <p><label class="red">Retype New Password:</label> <input type="password" name="confirm_password"></p>
